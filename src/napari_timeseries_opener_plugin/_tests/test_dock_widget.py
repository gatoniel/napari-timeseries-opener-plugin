import napari_timeseries_opener_plugin
import pytest

# this is your plugin name declared in your napari.plugins entry point
MY_PLUGIN_NAME = "napari-timeseries-opener-plugin"
...
def test_something_with_viewer(widget_name, make_napari_viewer, napari_plugin_manager):
    napari_plugin_manager.register(napari_timeseries_opener_plugin, name=MY_PLUGIN_NAME)
